...
import {huggingFaceModels} from '../Models/models';
  ...
  },
  {
    ...
    staticModels: [
      ...
      { 
        ...
        label: 'meta-llama/Meta-Llama-3-8B-Instruct-Lite', 
        provider: 'Together',
      },
      { 
      ...
      { 
        name: 'llama-2-7b-32k', 
        label: 'LLaMA-2-32K (7B)', 
        provider: 'Together',
       
      },
      { 
        name: 'evo-1-131k-base', 
        label: 'Evo-1 Base (131K)', 
        provider: 'Together',
    ...
    getApiKeyLink: 'https://api.together.xyz/settings/api-keys' // Replace with the actual API key URL if different
  },  
  {
    name: 'HuggingFace',
    staticModels: huggingFaceModels ,
